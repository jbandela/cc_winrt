...
//Adapted from http://msdn.microsoft.com/en-us/library/vstudio/jj155852.aspx
// All modifications
...
#if 1
#include <stdio.h>
#include "winrt_device_enumeration.h"
#include <Windows.h>
...
int wmain()
{
	...
	auto hr = enumerationCompleted.IsValid() ? S_OK : HRESULT_FROM_WIN32(GetLastError());
	if (FAILED(hr))
	{
		return PrintError(__LINE__, hr);
	}
