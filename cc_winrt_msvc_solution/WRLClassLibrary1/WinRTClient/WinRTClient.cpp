...
template <class T> struct InterfaceUriRuntimeClass:public InterfaceDefinitions::InterfaceUriRuntimeClass::Interface<T>{};
template<class T> struct InterfaceUriRuntimeClassFactory:public InterfaceDefinitions::InterfaceUriRuntimeClassFactory::Interface<T>{};
